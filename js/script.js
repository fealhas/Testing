$(function(){
     ...
     */
    $(function($){
        $('.shortcut').mouseenter (function(event){
            $(this).parent().parent().find('.title').addClass('green');
        });
        $('.shortcut').mouseleave (function(event){
            $(this).parent().parent().find('.title').removeClass('green');
        });
        ...
        $('#moduleChooseDialog').dialog({
           ...
           buttons:{
               'Ok' : function() {
                     $.ajax({
                    'type':'POST',
                    'url':'/SDynaTreeEditor/docTree/setModule/',
                    'cache':false,
                    'data': {'curModule' : $('#curModule').val()},
                    'success': function() {
                           $(this).dialog('close');
                           window.location='/SDynaTreeEditor';
                    }
                    });
               }
           }
    ...
    $('body').delegate('#docTreeEditorShortcut','click',function(){
         $('#moduleChooseDialog').dialog('open');
         return false;
    });
     ...
     * */
    $('.bloc .title').not('.hide').append('<a href="#" class="toggle"></a>');
    $('.bloc .title.hide').append('<a href="#" class="toggle hide"></a>');
    ...
    **/
     ...
     * */
    $('.tabs').each(function(){
        var current = $(this).find('a:first').addClass('active').attr('href');
