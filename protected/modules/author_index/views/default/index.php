<div class="bloc abs">
    <div class="title">
            Именной указатель
            <div class='tabs'>
            <a href="#author_index" id='auth_index'>Именной указатель</a>
	...
	$this->renderPartial('application.modules.author_index.views.authorIndex.index', array(
			     'model'=>$model,
			     ));
	?>
    </div>
	...
	<?php
	$model = new Data();
	$this->renderPartial('application.modules.author_index.views.authorIndex.search',
			     array(
				   'model'=>$model
				  )
			     );
	...
	$this->renderPartial('application.modules.author_index.views.dictionary.index',
			     array('model'=>$model));
	?>
    </div>
</div>
