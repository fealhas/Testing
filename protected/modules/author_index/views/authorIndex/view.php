...
<?php
$this->renderPartial('application.modules.author_index.views.authorIndex.cat_view',
...
<?php
$this->renderPartial('application.modules.author_index.views.authorIndex.updateButtons',
					  array('model'=>$model,
						));
?>
</div>
