...
<div class="bloc abs">
    <div class="title">
            ЗАГС Смерть
            <div class='tabs'>
            <a href="#author_index" id='auth_index'>ЗАГС Смерть</a>
	...
	$this->renderPartial('application.modules.zags_death.views.authorIndex.index', array(
			     'model'=>$model,
			     ));
	?>
    </div>
	...
	<?php
	$model = new Data();
	$this->renderPartial('application.modules.zags_death.views.authorIndex.search',
			     array(
				   'model'=>$model
				  )
			     );
	...
	$this->renderPartial('application.modules.zags_death.views.dictionary.index',
			     array('model'=>$model));
	?>
    </div>
</div>
