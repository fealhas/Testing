...
$isEditor = Yii::app()->user->checkAccess('Zags_birth.Data.Update');
// если юзер из центра или тарского филиала, контроль отображения editor_buttons будет при переходе по дереву
