...
<div class="bloc abs">
    <div class="title">
            ЗАГС Рождение
            <div class='tabs'>
            <a href="#author_index" id='auth_index'>ЗАГС Рождение</a>
	...
	$this->renderPartial('application.modules.zags_birth.views.authorIndex.index', array(
			     'model'=>$model,
			     ));
	?>
    </div>
	...
	<?php
	$model = new Data();
	$this->renderPartial('application.modules.zags_birth.views.authorIndex.search',
			     array(
				   'model'=>$model
				  )
			     );
	...
	$this->renderPartial('application.modules.zags_birth.views.dictionary.index',
			     array('model'=>$model));
	?>
    </div>
</div>
